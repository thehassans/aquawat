...
import { X, Search, Bell, Moon, Sun, Globe, LogOut, Mail, Menu as MenuIcon } from 'lucide-react'
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 sm:p-6 h-20 shrink-0 border-b border-gray-200/30 dark:border-white/5 shadow-sm dark:shadow-none">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              >
                {theme === 'dark' ? (
                  <Sun className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-white" />
                ) : (
              ...
              <Menu as="div" className="relative ms-2">
                ...
                <Transition
                  ...
                  leaveTo="transform opacity-0 scale-95"
                >
                  <Menu.Items className="absolute end-0 mt-2 w-48 origin-top-right bg-white dark:bg-dark-800 rounded-xl shadow-xl ring-1 ring-black/5 dark:ring-white/10 focus:outline-none py-1 z-50">
                    <Menu.Item>
                      {({ active }) => (
                        <button
                          onClick={() => {
