...
export const SO_STATUS_META = {
  ...
  draft: { en: 'Draft', ar: 'مسودة', tone: 'slate' },
  sent: { en: 'Sent', ar: 'مُرسل', tone: 'sky' },
  pending_approval: { en: 'Pending approval', ar: 'بانتظار الموافقة', tone: 'amber' },
  approved: { en: 'Confirmed', ar: 'مؤكد', tone: 'emerald' },
  locked: { en: 'Locked', ar: 'مقفل', tone: 'violet' },
  partially_delivered: { en: 'Partially delivered', ar: 'تسليم جزئي', tone: 'teal' },
  delivered: { en: 'Delivered', ar: 'مُسلّم', tone: 'emerald' },
  billed: { en: 'Invoiced', ar: 'مفوتر', tone: 'violet' },
