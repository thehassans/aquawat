...
const fallbackPlans = [
  {
    ...
    icon: Zap,
    color: '#059669',
    featuresEn: ['1 user', '50 invoices / month', '50 quotations / month', 'Inventory & Warehouses', 'Purchase Orders', 'Basic Reports', 'Email Support'],
    featuresAr: ['مستخدم واحد', '50 فاتورة / شهر', '50 عرض سعر / شهر', 'المخزون والمستودعات', 'أوامر الشراء', 'تقارير أساسية', 'دعم بالبريد'],
  },
  {
    id: 'professional',
    nameEn: 'Professional',
    ...
    icon: Sparkles,
    color: '#059669',
    featuresEn: ['3 users', '100 invoices / month', '100 quotations / month', 'HR & Payroll', 'Expenses & Finance', 'Projects & Tasks', 'WhatsApp Integration', 'Advanced Reports', 'Priority Support'],
    featuresAr: ['3 مستخدمين', '100 فاتورة / شهر', '100 عرض سعر / شهر', 'الموارد البشرية والرواتب', 'المصروفات والمالية', 'المشاريع والمهام', 'تكامل واتساب', 'تقارير متقدمة', 'دعم ذو أولوية'],
  },
  {
    id: 'enterprise',
    nameEn: 'Enterprise',
