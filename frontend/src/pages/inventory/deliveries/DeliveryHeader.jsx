...
import { toDeliveryUiState } from './deliveryState'
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0 space-y-1">
          <p className="text-xs font-medium tracking-wide text-slate-500">
            ...
            <Link to={listPath} className="hover:text-slate-800 dark:hover:text-slate-200">
              {ar ? 'أوامر التسليم' : 'Delivery Orders'}
            </Link>
            {!isNew && title ? (
              <>
                <span className="mx-1.5 text-slate-300">/</span>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <h1 className="text-xl font-semibold tracking-tight text-slate-900 dark:text-white">
              {isNew
                ? (ar ? 'أمر تسليم جديد' : 'New Delivery Order')
                : (title || (ar ? 'أمر تسليم' : 'Delivery Order'))}
            </h1>
