/**
 * Inventory v2 menu tree — client fallback when /api/inventory/menu is unavailable.
...
/** @typedef {{ id: string, label: string, labelAr: string, href?: string, action?: string, flag?: string, permission?: object, children?: object[], type?: string, end?: boolean }} InventoryMenuNode */
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        labelAr: 'تحويلات مجمّعة',
        href: '/app/dashboard/inventory/batches',
        flag: 'batchTransfers',
        permission: { module: 'inventory', action: 'read' },
      },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        labelAr: 'نقاط الجودة',
        href: '/app/dashboard/inventory/quality-points',
        flag: 'quality',
        permission: { module: 'inventory', action: 'read' },
      },
