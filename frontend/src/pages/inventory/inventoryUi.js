export const INVENTORY_PATH = {
  ...
  variants: '/app/dashboard/inventory/products/variants',
  picking: (id) => `/app/dashboard/inventory/pickings/${id}`,
  batches: '/app/dashboard/inventory/operations/batches',
  batch: (id) => `/app/dashboard/inventory/operations/batches/${id}`,
  ...
  locationsReport: '/app/dashboard/inventory/reporting/locations',
  forecastReport: '/app/dashboard/inventory/reporting/forecast',
  ...
  locations: '/app/dashboard/inventory/configuration/locations',
  operationTypes: '/app/dashboard/inventory/configuration/operation-types',
