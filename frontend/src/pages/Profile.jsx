...
export default function Profile() {
  ...
  const canEditCompany = ['admin', 'super_admin', 'superadmin', 'owner'].includes(String(user?.role || ''))
  ...
  const openCompanyEdit = () => {
    if (!canEditCompany) {
      toast.error(language === 'ar' ? 'تعديل بيانات الشركة للمسؤول فقط' : 'Only administrators can update company profile')
      return
    }
  ...
  return (
    <div className="min-h-screen pb-16 space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="flex items-start gap-5 sm:gap-6">
              <div className="relative group">
                ...
                <button
                  type="button"
                  onClick={openCompanyEdit} hidden={!canEditCompany}
      ...
      <AnimatePresence>
        {isEditModalOpen && canEditCompany && (
