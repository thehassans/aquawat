  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/app/dashboard/restaurant/kds', icon: Monitor, label: language === 'ar' ? 'شاشة المطبخ' : 'KDS Board', perm: { module: 'restaurant', action: 'read' }, requireAnyApp: ['restaurant_kds', 'kds_board'] },
