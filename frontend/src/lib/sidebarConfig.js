    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          activePrefixes: ['/app/dashboard/quotations', '/app/dashboard/sales/orders', '/app/dashboard/sales/teams', '/app/dashboard/sales/customers', '/app/dashboard/sales/configuration', '/app/dashboard/sales/reporting', '/app/dashboard/sales'],
          children: [
            ...
            { path: '/app/dashboard/sales/orders', label: language === 'ar' ? 'أوامر البيع' : 'Sale orders', perm: { module: 'invoicing', action: 'read' } },
            { path: '/app/dashboard/sales/teams', label: language === 'ar' ? 'فريق المبيعات' : 'Sales team', perm: { module: 'invoicing', action: 'read' } },
            { path: '/app/dashboard/sales/customers', label: language === 'ar' ? 'العملاء' : 'Customers', perm: { module: 'invoicing', action: 'read' } },
            ...
            { path: '/app/dashboard/sales/reporting', label: language === 'ar' ? 'تقارير المبيعات' : 'Reporting', perm: { module: 'invoicing', action: 'read' } },
          ],
        },
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/app/dashboard/accounting', icon: Calculator, label: language === 'ar' ? 'المحاسبة' : 'Accounting', perm: { module: 'finance', action: 'read' }, end: true, children: [
          ...
          { path: '/app/dashboard/accounting/invoices', label: language === 'ar' ? 'العملاء · الفواتير' : 'Customers · Invoices', perm: { module: 'invoicing', action: 'read' } },
          ...
          { path: '/app/dashboard/accounting/bank-recon', label: language === 'ar' ? 'التسوية' : 'Reconciliation' },
          { path: '/app/dashboard/accounting/balance-sheet', label: language === 'ar' ? 'الميزانية' : 'Balance Sheet' },
          { path: '/app/dashboard/accounting/pnl', label: language === 'ar' ? 'الأرباح والخسائر' : 'Profit & Loss' },
          { path: '/app/dashboard/accounting/trial', label: language === 'ar' ? 'ميزان المراجعة' : 'Trial Balance' },
          { path: '/app/dashboard/accounting/tax-report', label: language === 'ar' ? 'تقرير الضريبة' : 'Tax report' },
          { path: '/app/dashboard/accounting/invoices/settings', label: language === 'ar' ? 'الإعدادات' : 'Configuration', perm: { module: 'invoicing', action: 'update' } },
          { path: '/app/dashboard/accounting/lock-dates', label: language === 'ar' ? 'تواريخ الإقفال' : 'Lock dates' },
        ] },
