    ...
    },
    {
      ...
      items: [
        ...
        { path: '/app/dashboard/accounting', icon: Calculator, label: language === 'ar' ? 'المحاسبة' : 'Accounting', perm: { module: 'finance', action: 'read' }, end: true, children: [
          ...
          { path: '/app/dashboard/accounting/invoices/settings', label: language === 'ar' ? 'إعدادات الفاتورة' : 'Invoice settings', perm: { module: 'invoicing', action: 'update' } },
          ...
          { path: '/app/dashboard/accounting/balance-sheet', label: language === 'ar' ? 'الميزانية العمومية' : 'Balance Sheet' },
          { path: '/app/dashboard/accounting/customer-account', label: language === 'ar' ? 'كشف حساب العميل' : 'Customer Account' },
          { path: '/app/dashboard/accounting/customer-summary', label: language === 'ar' ? 'ملخص العملاء' : 'Customer Summary' },
          { path: '/app/dashboard/accounting/supplier-account', label: language === 'ar' ? 'كشف حساب المورد' : 'Supplier Account' },
          { path: '/app/dashboard/accounting/supplier-summary', label: language === 'ar' ? 'ملخص الموردين' : 'Supplier Summary' },
