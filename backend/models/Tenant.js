...
const subscriptionSchema = new mongoose.Schema({
  ...
  maxQuotations: { type: Number, default: 10 },
...
const tenantSchema = new mongoose.Schema({
  ...
  settings: {
    ...
    invoiceBranding: {
      ...
      singleLineHeading: { type: Boolean, default: false },
      /** Heading + footer text color (letterhead chrome) */
      letterheadTextColor: { type: String, default: '#0F172A' },
      /** Header + footer accent/border color (letterhead chrome) */
      letterheadAccentColor: { type: String, default: '#0F172A' },
    ...
    saudiIntegrations: {
      ...
      industrySpecific: {
        baladyApiKey: { type: String, default: '' },
        saberToken: { type: String, default: '' },
        etimadUser: { type: String, default: '' },
        etimadPassword: { type: String, default: '' },
      },
      zatcaConnectionStatus: { type: String, default: 'disconnected' },
      zatcaConnectedAt: { type: Date },
      zatcaLastTestedAt: { type: Date },
      zatcaLastError: { type: String, default: '' },
      elmConnectionStatus: { type: String, default: 'disconnected' },
      elmConnectedAt: { type: Date },
      elmLastTestedAt: { type: Date },
      elmLastError: { type: String, default: '' },
      qiwaConnectionStatus: { type: String, default: 'disconnected' },
      qiwaConnectedAt: { type: Date },
      qiwaLastTestedAt: { type: Date },
      qiwaLastError: { type: String, default: '' },
      gosiConnectionStatus: { type: String, default: 'disconnected' },
      gosiConnectedAt: { type: Date },
      gosiLastTestedAt: { type: Date },
      gosiLastError: { type: String, default: '' },
      baladyConnectionStatus: { type: String, default: 'disconnected' },
      baladyConnectedAt: { type: Date },
      baladyLastTestedAt: { type: Date },
      baladyLastError: { type: String, default: '' },
      saberConnectionStatus: { type: String, default: 'disconnected' },
      saberConnectedAt: { type: Date },
      saberLastTestedAt: { type: Date },
      saberLastError: { type: String, default: '' },
      etimadConnectionStatus: { type: String, default: 'disconnected' },
      etimadConnectedAt: { type: Date },
      etimadLastTestedAt: { type: Date },
      etimadLastError: { type: String, default: '' },
    },
    communication: {
      email: {
        enabled: { type: Boolean, default: false },
