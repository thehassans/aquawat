...
export function extractDateOnly(value) {
  ...
  // Prefer Asia/Riyadh calendar day for Instant values from Mongo/ISO.
  try {
...
/** End of calendar month for a YYYY-MM-DD (or Date/string). */
...
/**
 * Persist date-only as noon UTC so Asia/Riyadh (±3) and most zones show the same calendar day.
 */
