...
export const DEFAULT_APP_CATALOG = [
  ...
  },
  {
    ...
    nameEn: 'Kitchen Display System (KDS)',
    nameAr: 'شاشة المطبخ الذكية (KDS)',
    taglineEn: 'Real-time kitchen order screen with ticket bumping and prep timers.',
    taglineAr: 'شاشة تفاعلية للمطبخ مع توقيتات التحضير وإنجاز الطلبات لحظياً.',
    descriptionEn: 'Replace paper kitchen slips with an interactive Kitchen Display System (KDS) board. Features color-coded prep timers, live order bumping, course management, and multi-station routing.',
    descriptionAr: 'استبدل الفواتير الورقية بشاشة عرض المطبخ التفاعلية (KDS) مع مؤقتات التحضير الملونة، ونقل الطلبات بين المحطات، وإدارة الطبخ لحظياً.',
    category: 'restaurant',
    appType: 'premium_addon',
    icon: 'monitor',
    version: '2.4.0',
    ...
    pricingTier: 'free',
    badge: 'Kitchen',
    defaultRoute: '/app/dashboard/restaurant/kds',
    businessTypeGrant: 'restaurant',
    featuresEn: [
      'Real-time order tickets with color-coded preparation timers',
      'One-tap ticket bumping and ready status updates',
      'Multi-station kitchen routing (Grill, Fryer, Salad, Dessert)',
      'Audio chimes and visual alerts for rush orders'
    ],
    featuresAr: [
      'تذاكر طلبات فورية مع مؤقتات تحضير ملونة',
      'نقل وتحديث حالة الطلبات بلمسة واحدة',
      'توجيه الطلبات لمحطات متعددة (شواية، مقالي، سلطات، حلويات)',
      'تنبيهات صوتية وبصرية للطلبات المستعجلة'
    ],
    configSchema: []
  },
  {
