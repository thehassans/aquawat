...
export const DEFAULT_APP_CATALOG = [
  ...
  {
    appId: 'restaurant_kds',
    nameEn: 'Kitchen Screen & KDS Display',
    nameAr: 'شاشة المطبخ الذكية ونظام KDS',
    taglineEn: 'Integrated kitchen order screen, KDS board, prep timers, station routing, and kitchen receipt printing.',
    taglineAr: 'شاشة تفاعلية للمطبخ مع توقيتات التحضير وإنجاز الطلبات وتوجيه المحطات وطباعة الإيصالات.',
    descriptionEn: 'Unified kitchen screen and interactive Kitchen Display System (KDS). Features color-coded prep timers, live order bumping, multi-station routing, audio chimes, and instant thermal kitchen ticket/receipt printing.',
    descriptionAr: 'شاشة موحدة للمطبخ ولوحة تفاعلية لعرض الطلبات (KDS) مع مؤقتات التحضير الملونة، ونقل الطلبات بين المحطات، وتنبيهات صوتية، وطباعة فورية لتذاكر المطبخ.',
    category: 'restaurant',
    appType: 'premium_addon',
    icon: 'monitor',
    version: '2.5.0',
    ...
    pricingTier: 'free',
    badge: 'Kitchen',
    defaultRoute: '/app/dashboard/restaurant/kitchen',
    businessTypeGrant: 'restaurant',
    featuresEn: [
      'Interactive KDS Kanban and streamlined orders table views',
      'Real-time order tickets with color-coded preparation timers',
      'One-tap print kitchen receipts & tickets with thermal printer integration',
      'Multi-station kitchen routing (Grill, Fryer, Salad, Dessert)',
      'Audio chimes and visual alerts for incoming orders'
    ],
    featuresAr: [
      'عرض كانبان التفاعلي وجداول الطلبات السريعة في شاشة واحدة',
      'تذاكر طلبات فورية مع مؤقتات تحضير ملونة',
      'طباعة فورية لإيصالات وتذاكر المطبخ مع الطابعات الحرارية',
      'توجيه الطلبات لمحطات متعددة (شواية، مقالي، سلطات، حلويات)',
      'تنبيهات صوتية وبصرية للطلبات الجديدة'
    ],
    configSchema: []
  },
  {
    appId: 'restaurant_cashier',
    nameEn: 'Cashier Panel & Open Orders',
    nameAr: 'لوحة الكاشير ومتابعة الطلبات',
    taglineEn: 'High-speed order settlement, open orders, card payment terminals, and cash drawer management.',
    taglineAr: 'لوحة كاشير سريعة لتسوية الحسابات، ومتابعة الطلبات المفتوحة، وربط نقاط البيع والأدراج النقدية.',
    descriptionEn: 'Dedicated cashier operations console for settling open orders, processing split payments, managing cash drawers, and printing guest thermal receipts.',
    descriptionAr: 'لوحة مخصصة لكاشير المطعم لتسوية الطلبات المفتوحة، وتقسيم المدفوعات، وإدارة الصناديق النقدية، وطباعة الإيصالات الحرارية.',
    category: 'restaurant',
    appType: 'premium_addon',
    icon: 'monitor',
    version: '2.3.0',
    ...
    pricingTier: 'free',
    badge: 'Cashier',
    defaultRoute: '/app/dashboard/restaurant/cashier',
    businessTypeGrant: 'restaurant',
    featuresEn: [
      'Live open and pending order lists with search',
      'One-tap cash, card, and POS terminal payments',
      'Guest thermal bill and receipt printing',
      'Shift balancing and settlement records'
    ],
    featuresAr: [
      'قوائم الطلبات المفتوحة والمعلقة مع البحث السريع',
      'دفع فوري نقدي أو عبر البطاقة وأجهزة مدى/الشبكة',
      'طباعة الفواتير والإيصالات الحرارية للعملاء',
      'موازنة الوردية وسجلات تسوية الصندوق'
    ],
    configSchema: []
  },
  {
    appId: 'restaurant_branches',
    nameEn: 'Restaurant Branches & Locations',
    nameAr: 'إدارة فروع المطعم',
    taglineEn: 'Multi-branch operations, central menu sync, and branch stock transfers.',
    taglineAr: 'إدارة فروع المطاعم المتعددة، ومزامنة القوائم، والتحويلات المخزنية.',
    descriptionEn: 'Coordinate multiple restaurant branches, centralize menu items and pricing, control per-branch stock levels, and monitor branch sales analytics from a single unified panel.',
    descriptionAr: 'تنسيق فروع المطاعم المتعددة، وتوحيد قوائم الطعام والأسعار، وإدارة مخزون كل فرع، والاطلاع على تقارير مبيعات الفروع من لوحة واحدة.',
    category: 'restaurant',
    appType: 'premium_addon',
    icon: 'building',
    version: '2.3.0',
    ...
    businessTypeGrant: 'restaurant',
    featuresEn: [
      'Multi-branch location profiles and manager assignments',
      'Per-branch menu item pricing and availability',
      'Inter-branch ingredient and stock transfers',
      'Consolidated multi-branch revenue and performance reports'
    ],
    featuresAr: [
      'ملفات تعريفية للفروع وتعيين المدراء والموظفين',
      'تسعير وتوفر الأصناف لكل فرع بشكل مستقل',
      'تحويل المواد الخام والمكونات بين الفروع',
      'تقارير مجمعة لإيرادات وأداء كافة الفروع'
    ],
    configSchema: []
  },
  {
    appId: 'restaurant_reservations',
    nameEn: 'Table Reservations & Booking',
    nameAr: 'حجوزات الطاولات والضيوف',
    taglineEn: 'Manage guest table bookings, party sizes, and reservation schedules.',
    taglineAr: 'إدارة حجوزات طاولات الضيوف، وأعداد الأفراد، ومواعيد الوصول.',
    descriptionEn: 'Streamline table reservations with customer contact details, party sizes, special dining requests, and live table assignment schedules for dine-in operations.',
    descriptionAr: 'تنظيم حجوزات الطاولات مع بيانات الضيوف، وأحجام المجموعات، والملاحظات الخاصة، وتخصيص الطاولات مع جدول مواعيد متكامل.',
    category: 'restaurant',
    appType: 'premium_addon',
    icon: 'calendar',
    version: '2.1.0',
    ...
    pricingTier: 'free',
    badge: 'Dine-In',
    defaultRoute: '/app/dashboard/restaurant/reservations',
    businessTypeGrant: 'restaurant',
    featuresEn: [
      'Visual table reservation calendar and time slots',
      'Customer contact details and dining preferences',
      'SMS/WhatsApp reservation confirmation alerts',
      'Live seating and table status tracking'
    ],
    featuresAr: [
      'تقويم وجدول تفاعلي لمواعيد الحجوزات',
      'سجل بيانات الضيوف وتفضيلات الجلوس',
      'تنبيهات وتأكيدات الحجز عبر الرسائل والواتساب',
      'تتبع إشغال وحالة الطاولات لحظياً'
    ],
    configSchema: []
  },
  {
    ...
    nameAr: 'المطعم الجماعي والكافتيريا',
